...
var SHELL = ['./', 'index.html', 'styles.css', 'store.js', 'api.js', 'data.js', 'webrtc.js', 'vendor/editor.bundle.js', 'collab.js', 'audio.js', 'sfu.js', 'vendor/livekit.bundle.js', 'views.js', 'classroom.js', 'app.js', 'manifest.webmanifest', 'icon.svg'];
