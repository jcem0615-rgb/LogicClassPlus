...
var SHELL = ['./', 'index.html', 'styles.css', 'store.js', 'api.js', 'data.js', 'webrtc.js', 'vendor/editor.bundle.js', 'collab.js', 'views.js', 'classroom.js', 'app.js', 'manifest.webmanifest', 'icon.svg'];
